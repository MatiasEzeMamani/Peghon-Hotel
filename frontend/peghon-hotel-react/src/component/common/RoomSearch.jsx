    ...
    try {
      ...
      if (response.statusCode === 200) {
        if (response.roomList.length === 0) {
          showError(
            "Habitación no disponible actualmente para el tipo de habitación y el rango de fechas seleccionado"
          );
          return;
        }
      ...
      showError(
        "Se produjo un error desconocido: " + err.response.data.message
      );
    }
  };
